...
namespace betauia.Controllers {
    ...
    public class VippsApiController : ControllerBase {
        ...
        private string _client_id = "451a3d2c-d526-4cbe-b59c-940be028ba7a";
        private string _client_secret = "dkJlVDhIOVdpZkFpVGs3T013aDM=";
        private string _subscription_key = "e3c20a6d93f94353a0fe3c0541c1eb0e";
        ...
        public IActionResult GetVippsToken() {
            ...
            request.AddHeader("Ocp-Apim-Subscription-Key", _subscription_key);
            request.AddHeader("client_secret", _client_secret);
            request.AddHeader("client_id", _client_id);
        ...
        public IActionResult InitiatePayment() {
            ...
            request.AddHeader("Accept-Encoding", "gzip, deflate");
            request.AddHeader("Cookie", "x-ms-gateway-slice=prod; stsservicecookie=ests; fpc=AiuvQ7gu0vpErBq_sxNUZGiQPThUAQAAAIVW39QOAAAA");
            request.AddHeader("Host", "api.vipps.no");
            request.AddHeader("Cache-Control", "no-cache");
            request.AddHeader("Accept", "*/*");
